     ...
     <div className=' flex justify-center  w-screen h-6/12  '> 
        <div className='pt-20  gap-28 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-3   '>
          {ProjectsDetails.map((project,index) => (
            ...
            <button className='transition-all duration-700 absolute bottom-0  px-20 opacity-0 group-hover:opacity-100 '>
              <div className=' rounded-full border-white border-2 p-1 mb-3'>
                <a href='#' ><FaGithub /></a>
              </div>
            </button>
            <button className='transition-all duration-700 absolute bottom-0 px-20 opacity-0 group-hover:opacity-100 '>
              <div className=' rounded-full hover:border-white hover:border-2 p-1 mb-3 ml-10'>
